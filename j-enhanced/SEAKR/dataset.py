...
def get_dataset(dataset_name: str, n_shot: int) -> Dataset:
    match dataset_name.lower():
        case "twowikihop" | "2wikimultihopqa" | "2wiki" | "two_wiki_hop":
...
class TwoWikiHop(Dataset):
    ...
    @classmethod
    def load_data(cls, file_path: str="/nvme2n1/ZhengTaoWorks/xqz/j-enhanced/data/multihop_data/2wikimultihopqa/dev.json"):
        dataset = []
...
class HotpotQA(Dataset):
    ...
    @classmethod
    def load_data(cls, file_path: str= "/nvme2n1/ZhengTaoWorks/xqz/j-enhanced/data/multihop_data/hotpotqa/hotpotqa-dev.json"):
        dataset = []
        with open(file_path, "r") as fin:
            js = json.load(fin)
            for example in js:
...
class IIRC(Dataset):
    ...
    @classmethod
    def load_data(cls, file_path: str= "/nvme2n1/ZhengTaoWorks/xqz/j-enhanced/data/multihop_data/iirc/iirc_train_dev/dev.json"):
        dataset = []
        with open(file_path, "r") as fin:
            js = json.load(fin)
            for tmp in js:
