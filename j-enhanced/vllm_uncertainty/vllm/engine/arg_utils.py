...
class EngineArgs:
    ...
    def add_cli_args(
        ...
        parser.add_argument(
            '--decision-mode',
            type=str,
            default=EngineArgs.decision_mode,
            choices=['eigen', 'jacobian', 'hybrid'],
            help='Controls which uncertainty signal downstream code should '
            'use for decisions. Defaults to eigen to preserve current '
            'behavior.')
        parser.add_argument(
            '--compute-jacobian',
            action='store_true',
            help='Reserved scaffold flag for future Jacobian-based '
            'uncertainty computation. Defaults to disabled.')
        parser.add_argument(
            '--skip-tokenizer-init',
            action='store_true',
