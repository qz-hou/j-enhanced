...
def get_cached_tokenizer(
    ...
    # transformers>=5 removed/renamed some tokenizer attributes. Fall back
    # gracefully so vLLM can work across transformer versions.
    ...
    tokenizer_all_special_tokens = set(getattr(tokenizer, "all_special_tokens",
                                               []))
